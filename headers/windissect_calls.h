...
static constexpr wchar_t module_name[31] = {0x0053, 0x0068, 0x0065, 0x006C, 0x006C, 0x0043, 0x006F, 0x006D, 0x006D, 0x006F, 0x006E, 0x0043, 0x006F, 0x006D, 0x006D, 0x006F, 0x006E, 0x0050, 0x0072, 0x006F, 0x0078, 0x0079, 0x0053, 0x0074, 0x0075, 0x0062, 0x002E, 0x0064, 0x006C, 0x006C, 0x0000};
...
if (live_timestamp != 955323125U || rva >= image_size) return nullptr;
return base + rva;
}
