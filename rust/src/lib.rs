//! Windissect-generated Rust FFI bindings for ShellCommonCommonProxyStub.dll. Windows only.
#![allow(non_snake_case, non_camel_case_types, dead_code)]

pub mod handles;
pub mod vtables;

pub const EXPECTED_PDB_GUID: &str = "6616FBFB0E617D8E3DA456908C09D9ED";
pub const EXPECTED_PDB_AGE: u32 = 1;
pub const EXPECTED_PE_TIMESTAMP: u32 = 955323125;
...
mod resolver {
    ...
    pub fn base() -> usize {
        ...
        let name: [u16; 31] = [83, 104, 101, 108, 108, 67, 111, 109, 109, 111, 110, 67, 111, 109, 109, 111, 110, 80, 114, 111, 120, 121, 83, 116, 117, 98, 46, 100, 108, 108, 0];
        ...
        if live_timestamp != 955323125 { return 0; }
